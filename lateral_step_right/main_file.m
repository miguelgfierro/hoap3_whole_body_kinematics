...
%Write files
%Write for robot
write_to_file (Ts, q_right_leg, q_left_leg, q_right_arm, q_left_arm, q_waist, q_head, head_movement, q_hand, hand_movement, hand_selection, 'lateralD.csv')

%Write for simulator
q = [q_right_leg; q_right_arm; q_left_leg; q_left_arm; q_waist;q_head;q_hand];
q=q';
xlswrite('lateralD.xls',q)
